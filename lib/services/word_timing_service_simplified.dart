...
Future<void> validateWordTimingServiceSimplified() async {
  if (kDebugMode) {
    print('=== WordTimingServiceSimplified Validation ===');
    ...
    try {
      ...
      print('✓ Timing data loaded: ${words.length} words');
      ...
      print('✓ Sentence boundaries loaded: ${boundaries.length} sentences');
      ...
      print('✓ Display text loaded: ${displayText.length} characters');
      ...
      print('✓ Get word at index: "${wordAt10?.word}"');

      print('=== All WordTimingServiceSimplified validations passed ===');
    } catch (e) {
